...
export const defaults: Params = {
  ...
  opTemp: 350, // hotter = more radiation = less mass

  // Power - you're drowning in it up there
  solarEff: 0.32, // panel efficiency
  ...
  radPen: 0.35, // radiation efficiency penalty
  aiLearn: 0.2, // the learning curve

  // Launch economics
  launchCost: 1500, // today's $/kg
  launchLearn: 0.3, // 30% cost reduction per doubling
